...
class Position:
    ...
    def __init__(self, symbol: str, quantity: float, average_price: float, last_price: Optional[float] = None):
    ...
    def update_last_price(self, price: float, timestamp: Optional[pd.Timestamp] = None) -> None:
