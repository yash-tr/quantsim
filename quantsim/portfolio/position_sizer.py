...
class PositionSizer(ABC):
    ...
    """
    @abstractmethod
    def size_order(self, portfolio: "Portfolio", signal: SignalEvent) -> Optional[float]:
        """
...
class RiskPercentageSizer(PositionSizer):
    ...
    def size_order(self, portfolio: "Portfolio", signal: SignalEvent) -> Optional[float]:
        ...
        stop_price = last_close * (1 - self.stop_loss_pct) if signal.direction == 'LONG' else last_close * (1 + self.stop_loss_pct)
