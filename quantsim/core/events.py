...
class MarketEvent(Event):
    ...
    def __repr__(self) -> str:
        return (f"MarketEvent(symbol='{self.symbol}', timestamp={self.timestamp}, type='{self.type}', "
...
class SignalEvent(Event):
    ...
    def __repr__(self) -> str:
        return (f"SignalEvent(symbol='{self.symbol}', timestamp={self.timestamp}, type='{self.type}', "
...
class OrderEvent(Event):
    ...
    def __repr__(self) -> str:
        return (f"OrderEvent(symbol='{self.symbol}', timestamp={self.timestamp}, type='{self.type}', "
...
class FillEvent(Event):
    ...
    def __repr__(self) -> str:
        return (f"FillEvent(symbol='{self.symbol}', timestamp={self.timestamp}, type='{self.type}', "
